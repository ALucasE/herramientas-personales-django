'''
Django settings for herramientas_personales project.
...
ROOT_URLCONF = 'herramientas_personales.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.is_active',
            ],
        },
    },
]

WSGI_APPLICATION = 'herramientas_personales.wsgi.application'
